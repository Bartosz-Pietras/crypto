 ...
 vector<Account> Manager::initialise_all_accounts()
{
    ...
    for(int i=0; i<data.size(); i+=8)
    {
        ...
        Accounts.__emplace_back(Object);
    }
    }
    else
    {
...
void Manager::save_all_data(vector<Account> &Accounts)
{
    fstream data_file;
...
void Manager::run()
{
    ...
    vector<Account> Accounts = this->initialise_all_accounts();
    do{
    cout << " ----------------------------------------------------------------------------- " << endl;
    cout << "|                                                                             |" << endl;
